import { _extends, _objectWithoutPropertiesLoose } from './chunk-WCYDYUGX.mjs';
import {
  emotion_styled_browser_esm_default,
  lightenColor,
  scope,
} from './chunk-UETLJUPZ.mjs';
import {
  require_checkPropTypes,
  require_object_assign,
  require_react,
} from './chunk-CGGDZUA2.mjs';
import { require_memoizerific } from './chunk-7NJ6NIF4.mjs';
import {
  __commonJS as __commonJS2,
  __toESM as __toESM2,
} from './chunk-KQFPYAFV.mjs';
import { __commonJS, __toESM } from './chunk-JCTATS4D.mjs';
...
Learn more about this warning here: https://fb.me/react-legacy-context%s`,
      ...
      var fakeInternalInstance = {},
        ...
        emptyRefsObject = new React6.Component().refs,
...
function getUAString() {
  ...
  return uaData != null && uaData.brands
    ? uaData.brands
        .map(function (item) {
...
function mapToStyles(_ref2) {
  ...
  var commonStyles = Object.assign({ position }, adaptive && unsetSides),
    _ref4 = roundOffsets === !0 ? roundOffsetsByDPR({ x, y }) : { x, y };
...
var defaultModifiers = [
  ...
  usePopper = function (referenceElement, popperElement, options) {
    ...
    var prevOptions = React2.useRef(null),
      ...
      _React$useState = React2.useState({
        styles: {
          popper: {
      ...
      updateStateModifier = React2.useMemo(function () {
        return {
          name: 'updateState',
          enabled: !0,
          phase: 'write',
      ...
      popperInstanceRef = React2.useRef();
    return (
      useIsomorphicLayoutEffect(
        function () {
...
var match = (0, import_memoizerific.default)(1e3)(
  ...
  Tooltip = import_react2.default.forwardRef(
    (
      {
        placement,
        hasChrome,
      ...
      import_react2.default.createElement(
        ...
        hasChrome &&
          withArrows &&
          import_react2.default.createElement(Arrow, {
            placement,
            ...arrowProps,
            color,
          }),
