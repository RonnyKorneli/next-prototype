import { require_react } from './chunk-CGGDZUA2.mjs';
import { require_memoizerific } from './chunk-7NJ6NIF4.mjs';
import { __export, __toESM } from './chunk-JCTATS4D.mjs';
var scope = (() => {
  let win;
  return (
    typeof window < 'u'
        ...
        if (unsafePseudoClasses) {
          for (
            var isNested = element.parent === children[0],
              commentContainer = isNested ? children[0].children : children,
...
var CacheProvider = EmotionCacheContext.Provider,
  ...
  ThemeContext = (0, import_react5.createContext)({});
  ...
  Emotion = withEmotionCache(function (props, cache, ref) {
    ...
    return (
      ...
      (0, import_react5.createElement)(
        ...
        null,
        (0, import_react5.createElement)(Insertion, {
          cache,
          serialized,
...
var import_hoist_non_react_statics2 = __toESM2(
  ...
  pkg = {
    ...
    peerDependencies: { '@babel/core': '^7.0.0', react: '>=16.8.0' },
    peerDependenciesMeta: {
      '@babel/core': { optional: !0 },
      '@types/react': { optional: !0 },
    },
    devDependencies: {
      '@babel/core': '^7.18.5',
...
var Insertion3 = function (_ref) {
    var cache = _ref.cache,
      ...
      rules = useInsertionEffectAlwaysWithSyncFallback(function () {
  ...
  ClassNames = withEmotionCache(function (props, cache) {
    ...
    return (
      ...
      (0, import_react4.createElement)(
        ...
        null,
        (0, import_react4.createElement)(Insertion3, { cache, serializedArr }),
        ele
      )
    );
  });
      ...
      var Styled = withEmotionCache(function (props, cache, ref) {
        ...
        return (
          ...
          (0, import_react3.createElement)(
            ...
            null,
            (0, import_react3.createElement)(Insertion5, {
              cache,
              serialized,
